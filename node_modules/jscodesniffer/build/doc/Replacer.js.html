...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: Resolver/Replacer.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: Resolver/Replacer.js</h1>
...
/*
* @constructor
* @alias module:lib/Resolver/Replacer
...
module.exports = function( srcCode ) {
	...
	*/
	var diffs = [];
	/** @lends module:lib/Resolver/Replacer.prototype */
	return {
		/**
		* Getter
		* @returns {string}
